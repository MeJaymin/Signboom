<?php
  ...
  if (mysqli_num_rows($result) == 1) {
	...
	{                                                                                                       //ta 6/14/2014 
      ...
      // Customers are getting repeat confirmations for these orders.
      // Route to Alison for debugging until this is fixed.
      //if (($orderid == 9089) || ($orderid == 9172) || ($orderid == 10042))								//ta 6/14/2014
      //  $customer_email = 'alison@usablewebdesigns.com';													//ta 6/14/2014
