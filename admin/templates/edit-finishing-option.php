    ...
    <div id="content">
      ...
      <div style="width: 840px; margin: 20px auto;">
        ...
        <ul class="vertical">
          ...
          <li>
            <label for="finishing_option_type">Option Type:</label>
            <select name="finishing_option_type" id="finishing_option_type">
              <option value="CHOOSE">Choose Option Type</option>
              <option value="CC" <?php if ($finishing_option_type == "CC") echo "selected"; ?>>CC</option>
              <option value="VP" <?php if ($finishing_option_type == "VP") echo "selected"; ?>>VP</option>
              <option value=""   <?php if ($finishing_option_type == "")   echo "selected"; ?>>None Specified</option>
            </select>
          </li>
          ...
          <li>
            <label for="finishing_short_name">Short Name:</label>
            <input name="finishing_short_name" id="finishing_short_name" style="width: 80px;" value="<?php echo $finishing_short_name; ?>"> Short Name (8 chars max) for Production Columns
          </li>

	  <li>
            <label for="finishing_option_queue">Queue:</label> 
            <select id="finishing_option_queue" name="finishing_option_queue">
              <option value=""        <?php if ($finishing_option_queue == '')       echo "selected"; ?>>None</option>
              <option value="Print"   <?php if ($finishing_option_queue == 'Print')  echo "selected"; ?>>Print</option>
              <option value="Lam"     <?php if ($finishing_option_queue == 'Lam')    echo "selected"; ?>>Lam</option>
              <option value="Kiss"    <?php if ($finishing_option_queue == 'Kiss')   echo "selected"; ?>>Kiss</option>
              <option value="CNC"     <?php if ($finishing_option_queue == 'CNC')    echo "selected"; ?>>CNC</option>
              <option value="Finish"  <?php if ($finishing_option_queue == 'Finish') echo "selected"; ?>>Finish</option>
            </select>
	    <span style="color: #cc0000;">You must schedule this change with Alison who has to modify code at the same time.</span>
          </li>
