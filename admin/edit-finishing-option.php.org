<?php 
  ...
  $result_optionset = mysql_query($query_optionset, $DBConn) or die(mysql_error());
  $optionset_name_array = array();
  $optionset_display_name_array = array();
  $j = 0;
  while ($row_optionset = mysql_fetch_array($result_optionset, MYSQL_BOTH))
  {
  ...
  else
  {
    ...
    else 
    {
      if (isset($_REQUEST['submit_edit_finishing_option'])) 
      {
        ...
        $finishing_option_set = mysql_real_escape_string($_POST['finishing_option_set']);
        $finishing_option_type = mysql_real_escape_string($_POST['finishing_option_type']);
        $finishing_option_name = mysql_real_escape_string($_POST['finishing_option_name']);
        $finishing_short_name = mysql_real_escape_string($_POST['finishing_short_name']);
        $finishing_option_queue = mysql_real_escape_string($_POST['finishing_option_queue']);
        $finishing_option_batch_day = mysql_real_escape_string($_POST['finishing_option_batch_day']);
        $finishing_option_description = mysql_real_escape_string($_POST['finishing_option_description']);
        $finishing_option_code = mysql_real_escape_string($_POST['finishing_option_code']);
        $extra_time = mysql_real_escape_string($_POST['extra_time']);
        $finishing_option_fixed_cost = mysql_real_escape_string($_POST['finishing_option_fixed_cost']);
        $finishing_option_variable_cost = mysql_real_escape_string($_POST['finishing_option_variable_cost']);
        $finishing_option_sort_group = mysql_real_escape_string($_POST['finishing_option_sort_group']);
        $finishing_option_sort_order = mysql_real_escape_string($_POST['finishing_option_sort_order']);
        $units_of_measure = mysql_real_escape_string($_POST['units_of_measure']); // EA, BS, SF, PF
        $units_per_hour = mysql_real_escape_string($_POST['units_per_hour']);
