...
//echo "edit-customer.php"; die;
  ...
  $j = 0;
  while ($row_discount = mysql_fetch_array($result_discount, MYSQL_BOTH))
  {
  ...
  if (isset($_REQUEST['account_name']) || isset($_REQUEST['email_address']))
  {
    ...
    else 
    {
      if (isset($_POST['submit_edit_customer'])) 
      {
        ...
        $province_state = mysql_real_escape_string($_POST['province_state']);
        $country = mysql_real_escape_string($_POST['country']);
        $postal_zip = mysql_real_escape_string($_POST['postal_zip']);
        $phone1 = mysql_real_escape_string($_POST['phone1']);
        $phone2 = mysql_real_escape_string($_POST['phone2']);
        $hint_question = mysql_real_escape_string($_POST['hint_question']);
        $hint_answer = mysql_real_escape_string($_POST['hint_answer']);
        $web_url = mysql_real_escape_string($_POST['web_url']);
        $discount = mysql_real_escape_string($_POST['discount']);
        $html_mail = mysql_real_escape_string($_POST['html_mail']);
        $default_courier = mysql_real_escape_string($_POST['default_courier']);
        $courier_account = mysql_real_escape_string($_POST['courier_account']);
        $user_level = mysql_real_escape_string($_POST['user_level']);
        $account_disable = mysql_real_escape_string($_POST['account_disable']);
        $pst_number = mysql_real_escape_string($_POST['pst_number']);
        $discount_coupon = mysql_real_escape_string($_POST['discount_coupon']);
        $next_contact = mysql_real_escape_string($_POST['next_contact']);
        $notes = mysql_real_escape_string($_POST['notes']);
        $mailing_list = mysql_real_escape_string($_POST['mailing_list']);
        $cell_number = mysql_real_escape_string($_POST['cell_number']);
        $cell_provider = mysql_real_escape_string($_POST['cell_provider']);
        $enable_text_message = mysql_real_escape_string($_POST['enable_text_message']);
        $team = mysql_real_escape_string($_POST['team']);
        //$copy_to_kim = mysql_real_escape_string($_POST['CopyToKim']); copy_to_kim
		$copy_to_kim = mysql_real_escape_string($_POST['copy_to_kim']);
...
End_Of_Query;
        ...
        $city_num_rows = mysql_num_rows($city_result);
        if ($city_num_rows == 0)
      ...
      if (!$found_an_error)
      {
        ...
        mysql_real_escape_string($_POST['nextContact']);
