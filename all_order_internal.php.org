...
<title>Signboom: Your Online Print Engine</title>
  ...
  <script src="script/allorder_180114n.js" LANGUAGE="JavaScript" TYPE="text/javascript"></script>
  ...
  <form action="" method="post" enctype="multipart/form-data" name="orderForm" id="orderForm">
    ...
    <div style="float: left; margin-top: 0px; margin-bottom: 10px;">
	  ...
	  <!-- one box: padding-left= 360px   two boxes: padding-left = 220px   three boxes: padding-left = 80px  -->
          <td class="feature_boxes" style="padding-top: 0; padding-left: 20px;">

	    <div style="width: 480px; float: right ; margin-left: 10px; border: solid 2px #02b0ed; padding: 5px;">
	      <span style="color: #03a6DF; font-weight: bold;">Signboom Internal Ordering Page</span> 
	      <br><br>
              180122: Differences between pages and recent changes.<br><br>
	      <a id="show_differences" href="#" onClick="showDifferences()";>Show Differences</a>
	      <div id="differences" style="display: none;">
	      180122: Differences from external order page.<br>
	      <ul>
	        <li>There are currently no differences between the internal and external order pages.</li>
              </ul>
	      180122: Recent changes<br>
	      <ul>
	        <li>The files that end up on the upload machine have a new naming format.</li>
              </ul>
	      <a href="#" onClick="hideDifferences()";>Hide Differences</a>
	      </div>
	    </div>
...
?>
    ...
    <table style="background-image: url(images/fade_tall.gif); background-position: bottom; background-repeat: repeat-x; background-color: #FFFFFF; border-style: solid; border-width: 1px; border-color:#000000;" cellspacing="0" cellpadding="2">
      <tr style="color: #FFFFFF; text-align: center; font-weight: bold; background-color: #03a6DF;">
