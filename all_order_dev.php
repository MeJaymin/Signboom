<?php
  ...
  include ('includes/ordutils_180122.php');
...
<title>Signboom: Your Online Print Engine</title>
  ...
  <script src="script/allorder_180122d.js" LANGUAGE="JavaScript" TYPE="text/javascript"></script>
  ...
  <?php
    ...
    echol ('var offline_customer_global = "'.$offline.'";');
    echol ('var customer_setup_fee_global = "'.$acctsetup.'";');
    echol ('var account_markup_global = "'.$acctmarkup.'";');
    ...
    <div style="float: left; margin-top: 0px; margin-bottom: 10px;">
	  ...
	  <!-- one box: padding-left= 360px   two boxes: padding-left = 220px   three boxes: padding-left = 80px  -->
	    ...
	    <div style="width: 550px; float: right ; margin-left: 10px; border: solid 2px #02b0ed; padding: 5px; text-align: center;">
	      <span style="color: #E70089; font-weight: bold;">Ability to Quote / Place Orders for Offline Customers</span> 
	      <br>
	      This page includes the new feature that allows Kim and Sandra to log in as themselves and then quote and place 
	      orders for offline customers. It will apply a customer-specific markup/discount for that account to the order.
	      </span> 
	      <!--
...
?>
    ...
    <table style="background-image: url(images/fade_tall.gif); background-position: bottom; background-repeat: repeat-x; background-color: #FFFFFF; border-style: solid; border-width: 1px; border-color:#000000;" cellspacing="0" cellpadding="2">
      <tr style="color: #FFFFFF; text-align: center; font-weight: bold; background-color: #000000;">
...
<?
  for ($i = 1; $i <= 10; $i++) {
    ...
    ?>
    <td>
      <a href="#" onClick="ChangeFinishing('<?php echo $i; ?>')" >
      ...
      <legend class="bluetext">Print Service</legend>
        <table>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td><input name="stdready" type="text" id="stdready" class="myinput" size="11" readonly="yes"></td>
          </tr>
          <tr>
            <td>RUSH Service:</td>
            ...
            <td><input name="rushready" type="text" id="rushready" class="myinput" size="11" readonly="yes"></td>
          </tr>
          <tr>
            <td>HOT Service:</td>
            ...
            <td><input name="hotready" type="text" id="hotready" class="myinput" size="11" readonly="yes"></td>
          </tr>
        </table>
      </fieldset>
